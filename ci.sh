...
sudo docker run -d -t -v /dev/bus/usb:/dev/bus/usb -v /dev/serial:/dev/serial -v /boot:/boot -v /lib/modules:/lib/modules -p 80:80 -p 2022:22 -h lava-docker --name lava --privileged lava
